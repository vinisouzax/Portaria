...
<html>
<!--TELA DE EDIÇÃO DE PORTARIAS DO DIRETOR, POIS TEM UM CAMPO A MAIS PARA MARCAR STATUS -->
  <head>
  ...
  <body class = "login-bg">
	...
	<div class = "content-wrap">
              ...
              <?php
              //ABRE FORMULARIO PARA EDITAR PORTARIA
	             echo form_open_multipart('Docportaria/UpdateDocPortariaDiretor'); ?>
							...
							<div   align = "left" style                    = "width:200px;height:40px;font-size: 13px;margin-right: 320px; float:right; margin-top: -90"><label>Status</label></div>
							<br>
							<!-- STATUS PORTARIA-->
              <select class = "form-control" style = "width:200px;height:40px;font-size: 13px;margin-right: 320px; float:right; margin-top: -67" type = "select" id = "status" name = "status" required>
              <option value = ''>Selecione o Status</option>
              <option value = "Retornada">Retornar Portaria</option>
              <option value = "Aprovada">Aprovar Portaria</option>
              </select>
              ...
              <div    class = "action"><!-- BOTAO ALTERAR-->
              <button class = "btn btn-primary signup" type = "submit"  id = "cadastrar" class = "cadastrar" name = "Alterar"  >Alterar</button>
